...
export class Apis1762784355680 implements MigrationInterface {
  name = 'Apis1762784355680';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."apis_status_enum" AS ENUM('draft', 'published')`,
    );
    await queryRunner.query(
      `CREATE TABLE "apis" ("id" BIGSERIAL NOT NULL, "name" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "description" text, "base_path" character varying(255) NOT NULL, "version" character varying(50) NOT NULL, "status" "public"."apis_status_enum" NOT NULL DEFAULT 'draft', "openapi_spec_key" character varying(512) NOT NULL, "openapi_spec_url" character varying(1024) NOT NULL, "created_by" bigint NOT NULL, "published_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_764266eafe31251723c495bbfc2" UNIQUE ("slug"), CONSTRAINT "UQ_71a51f64cb0e4e1e6db23364d51" UNIQUE ("base_path"), CONSTRAINT "UQ_5e144c098f59ecaa09dcbebef1d" UNIQUE ("openapi_spec_key"), CONSTRAINT "PK_a74a5f3f4f08faf9f6329bceae6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "api_keys" ADD CONSTRAINT "FK_6bbcf643f7359258224f1712843" FOREIGN KEY ("api_id") REFERENCES "apis"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
